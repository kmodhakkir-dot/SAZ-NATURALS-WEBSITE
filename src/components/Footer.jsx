    ...
    <footer className="bg-card border-t border-border py-14">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-10 mb-10">
          <div>
            ...
            <div className="flex gap-3">
              <a href="https://wa.me/255655799575" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="w-9 h-9 rounded-full bg-primary-500/10 text-primary-500 hover:bg-primary-500 hover:text-white flex items-center justify-center transition-colors">
              ...
              <a href="https://facebook.com/saznaturals" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-9 h-9 rounded-full bg-primary-500/10 text-primary-500 hover:bg-primary-500 hover:text-white flex items-center justify-center transition-colors">
        ...
        <div className="pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4 text-sm">
          <p className="text-foreground/60">© {year} SAZ Naturals. All rights reserved.</p>
